       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Voir les heures supplémentaires</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Accueil</a></li>
              <li class="breadcrumb-item active" aria-current="page">Voir les supplémentaires</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Voir les supplémentaires</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3" style="max-height:500px; overflow-y:auto; ">
                        <div class="col-xl-6">
                        <label class="form-control-label">Choisir les jours<span class="text-danger ml-2">*</span></label>
                        <select required name="type" onchange="typeDropDown(this.value)" class="form-control mb-3">
                          <option value="">--Choisir--</option>
                          <option value="1" >Un jour(date precisé)</option>
                          <option value="2" >Une intervaille donnée</option>
                        </select>
                        </div>
                    ...
                    <button type="submit" name="view" class="btn btn-primary">Voir les heures</button>
                  </form>
                </div>
              </div>
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "2"){ //Date Range Attendance
